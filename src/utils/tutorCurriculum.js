...
const MANODHARMA_ADVANCED_CURRICULUM_RAW = [
    // ── Stage 5: Advanced Kalpanaswaram & The Tani ─────────────────────────────
    {
        id: 'mano_stage5', title: 'Stage 5: Advanced Kalpanaswaram & The Tani',
        symbol: '⚡',
        subtitle: 'Multi-cycle swara chains, eduppu navigation, and the tani handoff',
        color: '#0a2a1a',
        tag: 'Stage 5',
        lessons: [
            {
                id: 'mano_5_1', title: 'The Mukthayi / Korvai Extension', tag: 'Practice',
                exercises: [
                    { type: 'info', title: 'Multi-Cycle Swara Chains', body: 'In Stage 2 and 3, you built 1-avartanam (8-beat) Kalpanaswaram phrases. The next level is multi-cycle chains — swara patterns that span 2 or 3 complete tala cycles before resolving.\n\nA 2-avartanam chain (16 beats) has two phases:\n• Phase 1 (beats 1–8): Build energy. Ascend toward the upper register.\n• Phase 2 (beats 9–16): Descend and resolve onto the Idam.\n\nA Mukthayi is the closing pattern of any Kalpanaswaram sequence — the rhythmic phrase that signals "I am about to land." A Korvai is a more elaborate Mukthayi: usually 3 repetitions of a multi-beat pattern that mathematically adds up to the Idam.\n\nThe key skill: you must know BEFORE you start a 2-cycle phrase that you have 16 beats. Plan your ascent, plan your Mukthayi, plan your landing — then execute.' },
                    { type: 'listen_sequence', swaras: ['Sa', 'Ri1', 'Ga3', 'Ma1', '|', 'Pa', 'Da1', '|', 'Ni3', 'Pa'], tala: { name: 'Adi', groups: [4, 2, 2], unitLabel: '8-beat cycle' }, instruction: 'Phase 1 of a 2-avartanam chain: 8 beats ascending from Sa toward the upper register, ending on Pa. Your hand completes one full Adi tala cycle. Count carefully — you have 8 more beats to resolve.' },
                    { type: 'listen_sequence', swaras: ['Ga3', 'Ma1', 'Pa', 'Ga3', '|', 'Ma1', 'Ri1', '|', 'Ga3', 'Sa'], tala: { name: 'Adi', groups: [4, 2, 2], unitLabel: '8-beat cycle' }, instruction: 'Phase 2: A Mukthayi descent over 8 beats — a leaping pattern (Dhaatu) that resolves cleanly on Sa. This completes the 2-avartanam chain.' },
                    { type: 'free_sing', duration: 20, instruction: 'Try a 2-avartanam Kalpanaswaram. Keep Adi Tala going. In the first 8 beats, build upward (Sa toward Ni). In beats 9–16, descend and land on Sa. Your hand counts both cycles. Keep track of where cycle 1 ends and cycle 2 begins.' },
                    { type: 'info', title: 'The Korvai Formula', body: 'A Korvai is a Mukthayi made from a pattern repeated exactly 3 times.\n\nFormula: (Pattern × N beats) × 3 = remaining beats to Idam\n\nExample: You have 12 beats left. Pattern = Pa Ma Ga (3 notes) + 1 rest = 4 beats. 4 × 3 = 12. ✓\n\nThis is the same logic as the Teermanam from Stage 3 — but a Korvai can span more complex patterns. The individual pattern can be 2, 3, 4, or even 5 beats, and the 3× repetition must add up exactly to the remaining beats before the Idam.\n\nThe craft of the Korvai is designing a pattern whose 3× repetition lands exactly on the Idam — not a beat early or late. Counting while singing (and planning before singing) is the only way to achieve this.' },
                    { type: 'quiz', question: 'A Korvai pattern is 5 beats long. How many total beats does the Korvai occupy?', choices: ['5 beats', '10 beats', '15 beats', '20 beats'], correct: '15 beats', explanation: 'A Korvai always repeats the pattern exactly 3 times. 5 beats × 3 = 15 beats. Your Kalpanaswaram must therefore begin the Korvai exactly 15 beats before the Idam. This math must be planned before you start singing.' }
                ]
            },
            {
                id: 'mano_5_2', title: 'Advanced Eduppu: Atita & Anagata', tag: 'Concept',
                exercises: [
                    { type: 'info', title: 'Starting Before or After the Beat', body: 'In Level 1 Kalpanaswaram, the Idam was always Beat 1 (Samam). More advanced practice introduces two offset starting positions:\n\n• Atita Eduppu (அதீத எடுப்பு): The lyric begins BEFORE Beat 1 — the phrase arrives slightly early and crosses over into the new cycle. Like a singer who anticipates the downbeat.\n\n• Anagata Eduppu (அனாகத எடுப்பு): The lyric begins AFTER Beat 1 — it enters a beat or two late, creating a sense of relaxed arrival.\n\nBoth require a different calculation of your available beats:\n• Atita: You have (8 − N) beats in the final cycle, where N = how many beats the phrase starts early\n• Anagata: You have (8 + N) beats, where N = how many beats the lyric is delayed\n\nThis is why concert Kalpanaswaram sounds so sophisticated — the singer simultaneously tracks a non-trivial Idam while improvising complex phrases.' },
                    { type: 'quiz', question: 'If a krithi uses Anagata Eduppu (lyric enters 2 beats after Samam), and you want to improvise exactly 1 avartanam of swaras, how many beats do you have?', choices: ['6 beats', '8 beats', '10 beats', '12 beats'], correct: '10 beats', explanation: 'With Anagata Eduppu, the lyric re-enters 2 beats after Beat 1 of the new cycle. So you have the standard 8 beats of the avartanam, plus 2 more beats before the lyric returns — giving you 10 total beats of improvisation space. Missing this calculation causes you to land 2 beats early or late.' },
                    { type: 'listen_sequence', swaras: ['Sa', 'Ri1', 'Ga3', 'Ma1', '|', 'Pa', 'Ga3', '|', 'Ri1', 'Ga3'], tala: { name: 'Adi', groups: [4, 2, 2], unitLabel: '8-beat cycle' }, instruction: 'Listen to a phrase that does NOT resolve on Beat 1 — it arrives on Ga3 at the last beat. This is how Atita or Anagata Eduppu sounds in practice: the resolved note is shifted by beats relative to Samam.' },
                    { type: 'info', title: 'How to Practice Eduppu Navigation', body: 'Start with Atita Eduppu of 1 beat: your lyric enters 1 beat before Samam.\n\nPractice frame:\n1. Keep Adi Tala with your hand\n2. Your improvisation starts on Samam (Beat 1)\n3. Your phrase must resolve on Beat 8 of the avartanam — 1 beat BEFORE the next Samam\n4. The krithi lyric then sings across the Samam boundary naturally\n\nHint: Use a Karvai (held note) near the end of your phrase to park safely while you mentally confirm the landing position. The hold is your "thinking zone" before the final descent.' },
                    { type: 'free_sing', duration: 20, instruction: 'Atita practice: Keep Adi Tala. Begin improvising from Beat 1. Target Beat 7 as your arrival beat (one beat early). Use a Karvai on Pa at beat 5 to plan the final descent. Land on Sa at beat 7. Keep the tala going steadily — do not slow down.' }
                ]
            },
            {
                id: 'mano_5_3', title: 'The Tani Avartanam Hand-off', tag: 'Concept',
                exercises: [
                    { type: 'info', title: 'What is the Tani Avartanam?', body: 'After the Kalpanaswaram section of a Carnatic concert, the vocalist signals the mridangam and other percussionists to take a percussion solo — the Tani Avartanam (தனி ஆவர்த்தனம்).\n\nThis is a complete percussion-only section, usually 4–16 avartanams long, where the vocalist stays silent and keeps tala.\n\nYour role during the Tani:\n1. Sit quietly and keep internal tala with light, minimal hand movements\n2. Follow the percussion\'s dynamic shape — they will build to a climax and resolve\n3. Know that the Tani ends when the percussion returns to Samam and pauses\n4. Re-enter smoothly with the next composed line of the krithi — usually the Pallavi or Anupallavi\n\nThe hand-off moment — the moment you re-enter after the Tani — must feel seamless, as if the music never paused. This requires precise tala-tracking through the entire percussion solo.' },
                    { type: 'quiz', question: 'What is the vocalist\'s primary responsibility during the Tani Avartanam?', choices: ['Singing quietly in the background', 'Keeping internal tala to re-enter accurately after the percussion solo', 'Playing the mridangam', 'Taking a complete break from music'], correct: 'Keeping internal tala to re-enter accurately after the percussion solo', explanation: 'During the Tani, the vocalist must track every beat silently. The re-entry must land exactly on the next Samam — a clean, inevitable return to the composed melody. This requires counting every avartanam of the percussion solo without losing the thread.' },
                    { type: 'taalam', instruction: 'Practice extended tala-keeping: continue Adi Tala without stopping for 6 full avartanams (48 beats). Close your eyes. Keep your internal count even if your hand movements become small. This simulates tracking tala through a short Tani Avartanam.' },
                    { type: 'info', title: 'Signalling the Tani', body: 'The vocalist signals the Tani with a specific musical gesture:\n\n• Sing the final Kalpanaswaram phrase cleanly\n• Resolve onto the Idam and hold it for at least 2 beats\n• Make brief eye contact with the percussionist — the traditional signal\n• Drop your hand movement to a very light, minimal gesture\n\nThe percussionists will then begin their solo on the next Samam.\n\nFor a student practicing alone, simulate the Tani by:\n1. Stopping singing after your Kalpanaswaram landing\n2. Silently counting 8 avartanams while keeping tala\n3. Re-entering with the krithi\'s Pallavi line on the next Samam\n\nThis trains the re-entry skill without requiring a live percussionist.' },
                    { type: 'free_sing', duration: 25, instruction: 'Simulate the Tani hand-off: (1) Sing a 2-avartanam Kalpanaswaram and land on Sa. (2) Continue tala silently for 4 more avartanams — count every beat internally. (3) Re-enter by singing "Sa Ri Ga Ma Pa" cleanly on the next Samam. The re-entry must feel inevitable, not hesitant.' }
                ]
            }
        ]
    },
    ...
    // ── Stage 6: Neraval ───────────────────────────────────────────────────────
    {
        id: 'mano_stage6', title: 'Stage 6: Neraval',
        symbol: '📜',
        subtitle: 'Melodic elaboration of a lyric line — bounded by words, raga, and tala',
        color: '#1a1a08',
        tag: 'Stage 6',
        lessons: [
            {
                id: 'mano_6_1', title: 'The Art of Neraval', tag: 'Concept',
                exercises: [
                    { type: 'info', title: 'What is Neraval?', body: 'Neraval (நேர்வல்) is perhaps the most musically demanding form of Manodharma improvisation. Unlike Kalpanaswaram (which uses solfège syllables), Neraval keeps the actual lyrics of the krithi throughout.\n\nThe structure: one line of a krithi is repeated many times, each time with a different melodic treatment — different notes, different phrase shapes, different emotional intensity — while the words and their positions within the tala remain fixed.\n\nThe constraint that makes Neraval hard: the words must always fall in exactly the same positions within the tala cycle. This is called Padagarbham — the syllabic footprint of the lyric inside the tala.\n\nIf a word falls on beat 3, it must fall on beat 3 in every variation. If a syllable is stretched, it stretches by exact beats — not freely. You cannot rewrite the syllable positions to suit your melody.' },
                    { type: 'quiz', question: 'What is "Padagarbham" in the context of Neraval?', choices: ['The emotion expressed in the lyric', 'The raga in which the line is sung', 'The fixed positions of syllables within the tala cycle across all variations', 'The name of the opening line used for Neraval'], correct: 'The fixed positions of syllables within the tala cycle across all variations', explanation: 'Padagarbham literally means "the seed of the word." In Neraval, every melodic variation must respect the exact placement of each syllable within the tala cycle — no syllable can be moved to a different beat. The melody changes; the syllable positions do not.' },
                    { type: 'info', title: 'Choosing a Neraval Line', body: 'The best lines for Neraval are long enough to span a full avartanam, melodically rich, and emotionally meaningful.\n\nTraditionally, the Anupallavi or Charanam lines of a krithi are preferred for Neraval — they have more melodic density than the Pallavi.\n\nCriteria for a good Neraval line:\n• Spans 1–2 complete avartanams\n• Has at least 6–8 syllables for variation room\n• Falls in a raga that permits gamakam (ornamentation)\n• Carries a strong poetic meaning that can support different emotional interpretations\n\nFor a learner, any familiar krithi line can be used as Neraval practice. The goal: sing the same words, differently, 4–5 times in a row without repeating a melodic phrase.' },
                    { type: 'free_sing', duration: 15, instruction: 'Take any line from Enna Thavam or another familiar krithi. Sing it plainly once. Then sing it again with the melody slightly altered — different approach to one note. Then a third time. Keep the words exactly in place. Focus only on changing the melody while the syllables stay on their beats.' },
                    { type: 'quiz', question: 'In Neraval, what can the singer change in each variation?', choices: ['The words of the lyric', 'The tala cycle', 'The melodic treatment, note choices, and ornamentation', 'The raga of the entire line'], correct: 'The melodic treatment, note choices, and ornamentation', explanation: 'In Neraval, the words and their tala positions are fixed. The singer varies only the melody — how notes approach each other, which notes are held, what gamakams are added, and the overall emotional arc of the phrase.' }
                ]
            },
            {
                id: 'mano_6_2', title: 'Gamakas and Bhava', tag: 'Practice',
                exercises: [
                    { type: 'info', title: 'Microtones in Neraval', body: 'Gamakas (கமகம்) are the ornamental glides, oscillations, and microtonal inflections that give Carnatic music its distinctive emotional richness.\n\nIn Neraval, gamakas are the primary tool for creating variation without changing syllable positions:\n\n• Kampita: oscillation on a note (governed by raga rules)\n• Jaru: a glide from one note to another (slide)\n• Ullasitam: a sharp flick upward from a note\n• Ravai: a rolling descent through neighboring notes\n\nIn Mayamalavagowla:\n• Kampita is strong on Ga3\n• Jaru descends naturally from Pa to Ma1\n• Ravai works beautifully from Ni3 down through Pa\n\nUsing an incorrect gamaka on the wrong note in a raga is as serious as singing a wrong note — it violates the raga\'s identity.' },
                    { type: 'quiz', question: 'What is the primary musical purpose of adding gamakas in Neraval?', choices: ['To show off technical vocal skill', 'To create melodic and emotional variation within fixed syllable positions', 'To change the raga mid-line', 'To make the tala more complex'], correct: 'To create melodic and emotional variation within fixed syllable positions', explanation: 'Gamakas allow the singer to create fresh emotional color within the strict constraint of fixed syllable positions. Two variations of the same Neraval line can sound completely different — one sorrowful, one joyful — purely through different gamaka choices on the same note.' },
                    { type: 'info', title: 'Bhava: Matching Emotion to Melody', body: 'Bhava (பாவம்) means emotional feeling. In Neraval, each melodic variation should ideally have a distinct emotional character:\n\n• Variation 1: Plain, clear statement — establish the meaning of the words\n• Variation 2: Questioning — approach the key note from below, as if asking\n• Variation 3: Sorrowful — slow down the key syllable, use a downward gamaka\n• Variation 4: Joyful — brighten toward the upper register, lighter ornaments\n• Variation 5: Intense — densest notes, highest pitch approached, most active gamakas\n\nThis emotional arc is not mandatory — but it is the ideal. Great Neraval takes the audience on a journey through the words, not just a musical exercise.' },
                    { type: 'free_sing', duration: 20, instruction: 'Take one line from a familiar krithi. Sing it 5 times. Assign each repetition a different emotion: (1) Plain statement, (2) Questioning, (3) Sorrowful (slower, lower), (4) Bright (upper register), (5) Intense (dense notes, peak approach). Keep the words on their same beats each time.' }
                ]
            },
            {
                id: 'mano_6_3', title: 'Trikalam: Three Speeds', tag: 'Practice',
                exercises: [
                    { type: 'info', title: 'Singing in Three Rhythmic Degrees', body: 'Trikalam (திரிகாலம்) means "three speeds" — singing the same lyric line in the 1st, 2nd, and 4th degrees of rhythmic speed.\n\n• 1st degree (Vilambita kala): One note per beat — slow and meditative\n• 2nd degree (Madhyama kala): Two notes per beat — conversational pace\n• 4th degree (Ati kala): Four notes per beat — rapid and dense\n\nThe tala cycle does NOT change speed. Only the notes assigned to each beat multiply.\n\nIn a Neraval Trikalam:\n1. Sing the line at 1st degree (1 note per beat)\n2. Sing it again at 2nd degree (twice as dense, same cycle)\n3. Sing it at 4th degree (extremely rapid delivery)\n\nAll three use the same avartanam length. The words remain recognizable even at 4th degree — a mark of true Neraval mastery.' },
                    { type: 'taalam', instruction: 'Practice the Adi Tala cycle at a steady tempo. Hold this exact tempo — do NOT speed up. This is the fixed reference against which all three speeds are measured. Even the fastest Trikalam degree uses this same cycle.' },
                    { type: 'listen_sequence', swaras: ['Sa', ',', ',', ',', '|', 'Ri1', ',', '|', 'Ga3', 'Ma1'], tala: { name: 'Adi', groups: [4, 2, 2], unitLabel: '8-beat cycle' }, instruction: '1st degree (Vilambita): One note per beat. Sa held for 4 beats, Ri1 for 2, then Ga3 and Ma1. Maximum space around each note — feel the meditation of slow speed.' },
                    { type: 'listen_sequence', swaras: ['Sa', 'Ri1', 'Ga3', 'Ma1', '|', 'Pa', 'Ga3', '|', 'Ri1', 'Sa'], tala: { name: 'Adi', groups: [4, 2, 2], unitLabel: '8-beat cycle' }, instruction: '2nd degree (Madhyama): Two notes per beat fill the same 8-beat cycle. The phrase now has 8 notes — twice as dense as 1st degree. Same tala, twice the information.' },
                    { type: 'free_sing', duration: 20, instruction: 'Trikalam practice: Take one short phrase (4–5 notes). Sing it at 1st degree (slow), then at 2nd degree (2× the notes in the same time), then attempt the 4th degree (4× density). Keep your hand tala at the exact same speed throughout all three degrees. Stop and restart if you rush the tala.' },
                    { type: 'quiz', question: 'In Trikalam, what changes when you shift from 1st to 4th degree?', choices: ['The tala cycle becomes faster', 'The number of notes per beat multiplies while the tala speed stays fixed', 'The raga changes for higher speeds', 'The lyrics are replaced with solfège syllables'], correct: 'The number of notes per beat multiplies while the tala speed stays fixed', explanation: 'Trikalam is a density shift, not a tempo shift. The tala cycle remains completely fixed. At 4th degree, four notes are placed inside each beat where one was before — creating the illusion of speed while the tala\'s reference pulse stays constant.' }
                ]
            }
        ]
    },
    ...
    // ── Stage 7: Tanam ─────────────────────────────────────────────────────────
    {
        id: 'mano_stage7', title: 'Stage 7: Tanam',
        symbol: '🥁',
        subtitle: 'Rhythmic pulsation that bridges free Alapana and metered Pallavi',
        color: '#2a0a1a',
        tag: 'Stage 7',
        lessons: [
            {
                id: 'mano_7_1', title: 'Introduction to Tanam', tag: 'Concept',
                exercises: [
                    { type: 'info', title: 'The Middle Path', body: 'Tanam (தானம்) is the second element of the Ragam Tanam Pallavi (RTP), positioned between the free Alapana and the metered Pallavi.\n\nIt is rhythmically alive but has no fixed tala cycle — instead it creates its own internal pulse using short, repeated syllable-note clusters.\n\nThe traditional Tanam syllables are:\n• Tha · Nam · Tha · Nam — the signature pattern\n• Tha · Na · Nom — a variant that flows faster\n• Aa · Na · Na · Nom — more open, melismatic\n\nEach syllable group has a note attached to it. The notes follow the raga\'s melodic contours. The syllables create the rhythmic drive.\n\nTanam feels like someone running — there is momentum and direction, but no fixed meter. The internal pulse is created by the evenness of the syllable patterns, not by a tala cycle.' },
                    { type: 'quiz', question: 'What distinguishes Tanam from Raga Alapana rhythmically?', choices: ['Tanam uses Adi Tala while Alapana uses Rupaka Tala', 'Tanam creates internal rhythmic momentum through syllable patterns, while Alapana is completely free of rhythmic pulse', 'Tanam has no melodic content, only rhythm', 'Tanam is always slower than Alapana'], correct: 'Tanam creates internal rhythmic momentum through syllable patterns, while Alapana is completely free of rhythmic pulse', explanation: 'Alapana is completely freeform — notes breathe at any pace, with silence and pause at will. Tanam introduces rhythmic drive using short repeated syllable clusters (tha-nam, tha-nam), creating momentum without being bound to a fixed tala cycle.' },
                    { type: 'info', title: 'The Feel of Tanam', body: 'The character of a Tanam phrase:\n\n• Short and punchy: each syllable cluster is 2–4 syllables maximum\n• Repeated with variation: the same syllable pattern repeats, but the attached notes change\n• Relentless: there are almost no long holds or pauses — the momentum is nearly continuous\n• Gradually ascending: like Alapana, Tanam builds from the lower register to the upper, but faster\n\nA beginner\'s Tanam framework:\n1. Start on Sa: "Tha-nam Sa · Tha-nam Sa"\n2. Move to Ri: "Tha-nam Ri · Tha-nam Ri"\n3. Expand upward: "Tha-nam Ga · Tha-nam Ma · Tha-nom Pa"\n4. Reach the peak: "Tha-nam Ni · Tha-nom Sa^"\n5. Cascade back down: "Aa-nam Pa · Aa-nam Ga · Tha-nom Sa"\n\nEach line is a slightly different phrase on the same syllable pattern. The raga shapes the notes; the syllables provide the drive.' },
                    { type: 'free_sing', duration: 15, instruction: 'Tanam on Sa: Sing "Tha-nam Sa" repeatedly, varying the approach to Sa each time — from below (Ni3 to Sa), from above (Ri1 to Sa), with a glide. Keep the syllable pattern even and steady. Feel the momentum building through repetition.' },
                    { type: 'free_sing', duration: 20, instruction: 'Simple ascending Tanam: Start with "Tha-nam Sa," then shift to "Tha-nam Ri," then "Tha-nam Ga," building upward through the raga. Let each note feel settled before moving to the next. Keep the syllable pulse even throughout.' }
                ]
            },
            {
                id: 'mano_7_2', title: 'Raga Mapping in Tanam', tag: 'Practice',
                exercises: [
                    { type: 'info', title: 'Three Sthayi Tanam', body: 'A complete Tanam covers all three registers (sthayis) of the raga:\n\n• Mandhra Sthayi (lower octave): Tanam on Pa· Da· Ni· — grounding the raga in the low register, often slower and heavier in feel\n• Madhya Sthayi (middle octave): Sa through Ni — the core of the Tanam, where the raga\'s personality is most fully expressed\n• Tara Sthayi (upper octave): Sa^ to Ni^ — the climax, often very rapid and technically demanding\n\nThe arc: begin in Mandhra Sthayi (or directly at Sa), build through Madhya Sthayi with increasing density, peak in Tara Sthayi, then cascade back down to Sa for the Tanam\'s conclusion.\n\nThe conclusion of a Tanam signals the transition to the Pallavi: the singer\'s phrases slow, resolve onto Sa, and a brief pause marks the shift to metered time.' },
                    { type: 'listen_sequence', octaveMode: 'strict', swaras: ['Pa.', 'Da1.', 'Ni3.', 'Sa', '|', 'Ri1', 'Ga3', '|', 'Ma1', 'Pa'], instruction: 'Mandhra-to-Madhya transition: Pa (lower), Da (lower), Ni (lower), Sa — then rising through Ri, Ga, Ma to Pa. This is the opening arc of a three-sthayi Tanam.' },
                    { type: 'listen_sequence', octaveMode: 'strict', swaras: ['Pa', 'Ni3', 'Sa^', ',', '|', 'Ni3', 'Sa^', '|', 'Sa^', 'Ni3'], instruction: 'Tara Sthayi arrival: Pa to Ni to Sa^ — reaching the upper octave peak. In a real Tanam, this moment is highly ornamented. Hear the arc of arrival at Sa^.' },
                    { type: 'free_sing', duration: 15, instruction: 'Mandhra Sthayi Tanam: Sing "Tha-nam Pa·" (lower Pa), "Tha-nam Da·" (lower Da), "Tha-nam Ni·" (lower Ni), ending on Sa. Use the lower octave notes only. Let the phrases feel heavy and grounded.' },
                    { type: 'free_sing', duration: 25, instruction: 'Full three-sthayi Tanam arc: (1) Begin in Mandhra Sthayi (Pa· through Ni· to Sa), (2) Build through Madhya Sthayi (Sa through all notes to Ni3), (3) Peak briefly at Tara Sa^, (4) Cascade back to middle Sa. Use "Tha-nam" syllables throughout. Keep the pulse even — this is the full shape of a concert Tanam.' },
                    { type: 'quiz', question: 'What signals the end of the Tanam section in an RTP performance?', choices: ['The mridangam begins playing', 'The singer\'s phrases slow, resolve onto Sa, and a brief pause marks the transition to metered Pallavi', 'The vocalist switches to solfège syllables', 'The tambura drone stops'], correct: 'The singer\'s phrases slow, resolve onto Sa, and a brief pause marks the transition to metered Pallavi', explanation: 'The Tanam concludes with a natural deceleration — phrases become less dense, resolve onto Sa, and a moment of silence marks the transition to the metered Pallavi. There is no formal signal — the musical deceleration itself is the signal.' }
                ]
            }
        ]
    },

    // ── Stage 8: Ragam Tanam Pallavi ───────────────────────────────────────────
    {
        id: 'mano_stage8', title: 'Stage 8: Ragam Tanam Pallavi (RTP)',
        symbol: '👑',
        subtitle: 'The crown jewel — fusing all Manodharma elements into one grand structure',
        color: '#1a2a08',
        tag: 'Stage 8',
        lessons: [
            {
                id: 'mano_8_1', title: 'The Pallavi Concept', tag: 'Concept',
                exercises: [
                    { type: 'info', title: 'What is a Pallavi?', body: 'In an RTP performance, the Pallavi is not a composed song — it is a specially crafted melodic line, usually 1–2 avartanams long, set to a complex or unusual tala.\n\nThe Pallavi line has three functions:\n1. It is the theme that anchors the entire RTP structure\n2. It is the line used for Neraval elaboration (melodic variations while keeping the words)\n3. It is the line that the Kalpanaswaram phrases must return to (the Idam is always the start of the Pallavi)\n\nA well-composed Pallavi line:\n• Is melodically interesting with characteristic raga phrases\n• Is set to a tala that allows interesting mathematics (Misra Chapu, Khanda Chapu, or complex Adi structures)\n• Is poetically meaningful — often one line from a Sanskrit shloka or Tamil lyric\n• Starts on a strong beat that makes the Idam clear\n\nFor a student, it is acceptable to use a Pallavi from the classical repertoire before attempting to compose one.' },
                    { type: 'quiz', question: 'In an RTP performance, what is the "Idam" for the Kalpanaswaram section?', choices: ['The first note of the raga', 'The Pallavi line\'s starting point — where the Pallavi lyric begins each time', 'Any convenient beat chosen by the singer', 'The end of the Tanam'], correct: 'The Pallavi line\'s starting point — where the Pallavi lyric begins each time', explanation: 'In RTP Kalpanaswaram, the Idam is the point where the Pallavi line restarts. All improvised swara phrases must calculate back to this exact beat. Missing it means the Pallavi lyric falls in the wrong position — a serious structural error in RTP.' },
                    { type: 'info', title: 'Composing vs. Choosing a Pallavi', body: 'Composing a new Pallavi line is an advanced skill — it requires understanding tala mathematics, raga grammar, and poetic meter simultaneously.\n\nFor a learner, the first step is working with an existing Pallavi:\n\nExample Pallavi (Mayamalavagowla, Adi Tala):\n"Brova Bharama Raghave" (Tyagaraja)\nLyric starts on Beat 1, spans one avartanam, has strong characteristic raga phrases.\n\nThe learning sequence:\n1. Learn the Pallavi line perfectly — both melody and words\n2. Sing it many times until the Idam is automatic\n3. Do 1-avartanam Kalpanaswaram (improvise for 8 beats, return to Pallavi on Beat 1)\n4. Expand to 2-avartanam Kalpanaswaram\n5. Finally add Neraval variations on the Pallavi line itself\n\nRTP is built layer by layer. Do not skip steps.' },
                    { type: 'free_sing', duration: 20, instruction: 'Choose any short, familiar krithi line as your practice Pallavi. Sing it 4 times in a row, keeping Adi Tala. After 4 repetitions, improvise 8 beats of Kalpanaswaram and return to the Pallavi line. Repeat this cycle 3 times. This is the micro-form of RTP Kalpanaswaram.' }
                ]
            },
            {
                id: 'mano_8_2', title: 'The Ragamalika Finale', tag: 'Concept',
                exercises: [
                    { type: 'info', title: 'Multi-Raga Improvisation', body: 'A Ragamalika (ராகமாலிகை) is a sequence of different ragas — a "garland of ragas." In advanced RTP Kalpanaswaram, the singer improvises through multiple ragas sequentially, each for a few avartanams, before returning to the original raga and Pallavi.\n\nThe structure:\n[Raga 1 swaras (base raga)] → [Raga 2 swaras] → [Raga 3 swaras] → ... → [Base raga swaras] → [Pallavi]\n\nEach raga transition must:\n1. End on a note common to both ragas (a pivot note)\n2. Sound natural — not jarring\n3. Be recognizable as a different raga to an informed listener\n\nCommon pivot note strategy:\n• Mayamalavagowla → Hamsadhwani: both share Sa, Ri, Ga, Pa, Ni. Pivot on Pa.\n• Hamsadhwani → Shankarabharanam: both share Sa, Ri, Ga. Pivot on Ga.\n• Shankarabharanam → Mayamalavagowla: pivot on Sa.\n\nFor a student: practice just 2-raga Ragamalika first.' },
                    { type: 'quiz', question: 'What is a "pivot note" in a Ragamalika raga transition?', choices: ['The highest note in the ascending scale', 'A note that exists in both ragas, allowing a smooth transition from one raga to the next', 'The tonic Sa of any raga', 'The Jiva Swara of the second raga'], correct: 'A note that exists in both ragas, allowing a smooth transition from one raga to the next', explanation: 'A pivot note belongs to both the raga you are leaving and the raga you are entering. Landing on this shared note makes the raga change feel inevitable and musical, rather than abrupt. Skilled singers plan their Ragamalika transitions around these pivot points.' },
                    { type: 'listen_sequence', swaras: ['Sa', 'Ri1', 'Ga3', 'Ma1', '|', 'Pa', 'Da1', '|', 'Ni3', 'Pa'], tala: { name: 'Adi', groups: [4, 2, 2], unitLabel: '8-beat cycle' }, instruction: 'Mayamalavagowla phrase ending on Pa — the pivot note. From Pa, the transition to Hamsadhwani (Sa, Ri2, Ga3, Pa, Ni3) is natural since Pa is shared between both ragas.' },
                    { type: 'free_sing', duration: 25, instruction: '2-raga Ragamalika: (1) Sing 4 beats of Mayamalavagowla phrases. (2) Land on Pa (the pivot). (3) Shift to Hamsadhwani (use Sa, Ri, Ga3, Pa, Ni3 — Hamsadhwani skips Ma and Da entirely). (4) After 4 beats, return to Pa and shift back to Mayamalavagowla. (5) Complete with a final phrase landing on Sa. This is a simple 2-raga Ragamalika Kalpanaswaram.' }
                ]
            },
            {
                id: 'mano_8_3', title: 'The Complete RTP Structure', tag: 'Practice',
                exercises: [
                    { type: 'info', title: 'The Full RTP Flow', body: 'The complete Ragam Tanam Pallavi is performed in this order:\n\n1. Ragam (Alapana): Free-rhythm exploration of the raga — Zones A, B, C — no tala, no lyrics\n\n2. Tanam: Rhythmic pulsation using Tha-Nam syllables — all three sthayis — no fixed tala but internal pulse\n\n3. Pallavi: State the Pallavi line clearly 2–3 times in the chosen tala\n\n4. Neraval: Elaborate the Pallavi line melodically — vary the notes while keeping words fixed\n\n5. Kalpanaswaram: Improvise swaras over 1–8 avartanams, returning to Pallavi Idam each time\n\n6. Ragamalika Kalpanaswaram (optional): Improvise through additional ragas before returning to the base raga and Pallavi\n\nThe whole structure can last 10 minutes (student recital) or over an hour (concert). Its length is determined by the depth of improvisation, not a fixed time.' },
                    { type: 'quiz', question: 'In what order are the sections of a Ragam Tanam Pallavi performed?', choices: ['Pallavi → Tanam → Ragam → Neraval → Kalpanaswaram', 'Ragam → Tanam → Pallavi → Neraval → Kalpanaswaram', 'Kalpanaswaram → Ragam → Tanam → Neraval → Pallavi', 'Tanam → Ragam → Pallavi → Kalpanaswaram → Neraval'], correct: 'Ragam → Tanam → Pallavi → Neraval → Kalpanaswaram', explanation: 'The RTP always flows from free to structured: Ragam (completely free) → Tanam (internally pulsed, no tala) → Pallavi (metered, fixed tala) → Neraval (melodic variation on fixed lyrics) → Kalpanaswaram (improvised swaras returning to Pallavi Idam).' },
                    { type: 'free_sing', duration: 15, instruction: 'Mini Ragam: Raga Alapana in Mayamalavagowla. Begin in Zone B. Return to Ga3 often. Build toward Sa^. This is the Ragam section of your mini-RTP.' },
                    { type: 'free_sing', duration: 15, instruction: 'Mini Tanam: Transition into Tanam syllables (Tha-nam). Build from Sa upward, using Tha-nam on each note. Create momentum. Aim to reach Sa^ and cascade back to Sa. This is the Tanam section of your mini-RTP.' },
                    { type: 'free_sing', duration: 30, instruction: 'Complete mini-RTP: (1) 30 seconds of Alapana, (2) 20 seconds of Tanam, (3) Sing your chosen Pallavi line 3 times in Adi Tala, (4) Vary the Pallavi melody twice (Neraval), (5) Improvise one 8-beat Kalpanaswaram and return to the Pallavi. This is the full structure in miniature.' }
                ]
            }
        ]
    },

    // ── Stage 9: Advanced Raga Alapana ─────────────────────────────────────────
    {
        id: 'mano_stage9', title: 'Stage 9: Advanced Raga Alapana',
        symbol: '🌌',
        subtitle: 'Long-form, large-scale raga definition through contour, pause, and climax',
        color: '#0a0a2a',
        tag: 'Stage 9',
        lessons: [
            {
                id: 'mano_9_1', title: 'Graha, Jiva, and Nyasa Swaras', tag: 'Concept',
                exercises: [
                    { type: 'info', title: 'Three Kinds of Structurally Important Notes', body: 'An advanced Raga Alapana is built around three classes of significant notes:\n\n• Graha Swara (கிரஹ ஸ்வரம்): The note that a phrase begins on. The choice of Graha Swara signals the raga\'s mood. In Mayamalavagowla, beginning a phrase on Ga3 signals a meditative quality; beginning on Pa signals a resolute one.\n\n• Jiva Swara (ஜீவ ஸ்வரம்): The "living note" — the soul note of the raga (covered in Stage 4). In Mayamalavagowla this is Ga3.\n\n• Nyasa Swara (ந்யாஸ ஸ்வரம்): The note a phrase resolves and rests on — the "landing note." In Mayamalavagowla, Pa and Sa are strong Nyasa Swaras; Ri1 and Da1 are weaker ones.\n\nIn an advanced Alapana, the singer consciously varies all three for each phrase: different Graha (start), circle the Jiva (soul), land on different Nyasa (finish). This creates melodic variety without randomness.' },
                    { type: 'quiz', question: 'What is a Nyasa Swara?', choices: ['The first note of a raga\'s ascending scale', 'The note a phrase rests and resolves on — the landing note', 'The fastest note in a phrase', 'Another name for the tonic Sa'], correct: 'The note a phrase rests and resolves on — the landing note', explanation: 'Nyasa means "placing" or "settling." A Nyasa Swara is the note that a melodic phrase settles on — the point of rest after melodic motion. Different ragas have characteristic Nyasa Swaras, and varying the Nyasa Swara across phrases gives an advanced Alapana its harmonic depth.' },
                    { type: 'quiz', question: 'In Mayamalavagowla, beginning an Alapana phrase on Ga3 signals what quality?', choices: ['An ascending, energetic departure toward the upper octave', 'A meditative, inward quality — Ga3 as Graha Swara emphasizes the raga\'s ancient character', 'A rhythmic, martial energy', 'A quick transition to a neighboring raga'], correct: 'A meditative, inward quality — Ga3 as Graha Swara emphasizes the raga\'s ancient character', explanation: 'Ga3 (Antara Gandhara) is both the Jiva Swara and a powerful Graha Swara in Mayamalavagowla. Beginning a phrase on it immediately invokes the raga\'s most characteristic note, emphasizing its ancient, meditative quality before even moving to another note.' },
                    { type: 'listen_sequence', swaras: ['Ga3', 'Ma1', 'Pa', 'Ga3', '|', 'Ri1', 'Ga3', '|', 'Sa', 'Ri1'], instruction: 'A phrase with Graha on Ga3, Jiva circled (Ga3 returns mid-phrase), Nyasa on Ri1. The phrase begins and ends on different notes — both within the raga — creating variety without randomness.' },
                    { type: 'free_sing', duration: 20, instruction: 'Advanced phrase construction: Sing 5 Alapana phrases, each starting (Graha) on a different note: Sa, Ri1, Ga3, Pa, Ni3. Each phrase should pass through Ga3 (Jiva) and rest on a different Nyasa Swara at the end. No tala. Slow, exploratory. This is conscious Graha-Jiva-Nyasa practice.' }
                ]
            },
            {
                id: 'mano_9_2', title: 'Vakra and Bhashanga Ragas', tag: 'Concept',
                exercises: [
                    { type: 'info', title: 'Ragas That Break the Rules', body: 'Most ragas follow a smooth, sequential ascending and descending scale. But some ragas are defined by deliberate deviations:\n\n• Vakra Raga (வக்ர ராகம்): A raga with a "zig-zag" or crooked scale — notes that go backward or skip in a specific prescribed way.\n\nExample: Hamsadhwani in Vakra treatment allows phrases like Sa Ri2 Sa Ga3 (dipping back to Sa before going up to Ga3). This is prescribed, not random.\n\n• Bhashanga Raga (பாஷாங்க ராகம்): A raga that "borrows" one or two notes from outside its own parent scale — foreign notes that appear only in specific phrase contexts.\n\nExample: Kapi is a Bhashanga raga. Its base uses Ri2, Ga2, Ma1, Da2, Ni2. But in specific descending phrases, it borrows Ga3 (from the Kalyani family), creating the characteristic tension that defines Kapi.\n\nFor an advanced Alapana in Vakra or Bhashanga ragas: you cannot simply use the scale — you must memorize and reproduce the prescribed crooked or borrowed patterns.' },
                    { type: 'quiz', question: 'What defines a Bhashanga raga?', choices: ['A raga with more than 7 notes', 'A raga that borrows one or two notes from outside its parent scale in specific phrase contexts', 'A raga that can only be sung at night', 'A raga without any Jiva Swara'], correct: 'A raga that borrows one or two notes from outside its parent scale in specific phrase contexts', explanation: 'Bhashanga (literally "borrowed phrase") ragas use foreign notes — notes not in their parent melakarta scale — but only in specific, prescribed phrase patterns. These borrowed notes create characteristic tensions and moods that make the raga instantly recognizable.' },
                    { type: 'info', title: 'Navigating Vakra Patterns in Alapana', body: 'Vakra patterns require memorization before improvisation. You cannot improvise a Vakra raga correctly without knowing exactly where the scale deviates.\n\nApproach for learning a Vakra raga Alapana:\n1. Learn the prescribed ascending Vakra pattern (arohana) note by note\n2. Learn the prescribed descending pattern (avarohana)\n3. Identify which notes are the Vakra points (where the scale zig-zags)\n4. Practice short phrases that include these Vakra points until they become automatic\n5. Only after the Vakra notes are fluent, begin improvising phrases that use them naturally\n\nThe common mistake: "improvising" in a Vakra raga by going up and down the scale and occasionally adding the foreign note randomly. This destroys the raga\'s identity. The Vakra pattern is not optional decoration — it IS the raga.' },
                    { type: 'quiz', question: 'What is the safest approach to improvising in a Vakra raga?', choices: ['Sing the notes in any order that sounds good', 'First memorize the prescribed Vakra patterns (arohana and avarohana), then improvise only after the Vakra points are fluent', 'Avoid the Vakra notes entirely during improvisation', 'Treat the raga as a normal scale and add ornaments later'], correct: 'First memorize the prescribed Vakra patterns (arohana and avarohana), then improvise only after the Vakra points are fluent', explanation: 'In a Vakra raga, the prescribed zig-zag pattern is not decoration — it defines the raga\'s identity. Improvising before the Vakra points are automatic leads to treating them as optional additions rather than structural requirements, which collapses the raga\'s character.' },
                    { type: 'free_sing', duration: 15, instruction: 'Vakra practice exercise: Sing Mayamalavagowla as usual. Then introduce one deliberate zig-zag into your phrase — for example: Sa Ri1 Sa Ga3 (dipping back to Sa before Ga3). Repeat this Vakra phrase until it feels natural. This is the foundational practice for any Vakra raga.' }
                ]
            },
            {
                id: 'mano_9_3', title: 'Long-form Alapana: Contour, Pause, Climax', tag: 'Practice',
                exercises: [
                    { type: 'info', title: 'The Architecture of a 10-Minute Alapana', body: 'A concert Alapana typically unfolds over 5–15 minutes. Its structure is not free-form chaos — it has a deliberate architectural shape:\n\n• Movement 1 — Establishment (2–3 min): Low and middle register. Slow phrases. Establish the raga\'s identity unambiguously. Return frequently to the Jiva Swara. No rush toward the upper octave.\n\n• Movement 2 — Exploration (3–5 min): Full middle register. Introduce longer, more complex phrases. Vary the Graha, Jiva, and Nyasa Swaras. Use Karvai holds strategically. Build density gradually.\n\n• Movement 3 — Ascent (2–3 min): Begin approaching the upper octave (Tara Sthayi). Short glimpses of Sa^ — approach it, retreat, approach again. Build anticipation.\n\n• Movement 4 — Climax (1–2 min): Arrive fully at Sa^ and hold it. From this peak, a long cascading descent through the full scale back to lower Sa. This cascade is the emotional peak of the Alapana.\n\n• Movement 5 — Resolution (1 min): Return to the middle register for quiet, simple phrases that declare the raga one last time before ending on Sa.\n\nThis arc is not a rigid rule — it is a musical instinct developed through listening and practice.' },
                    { type: 'info', title: 'Using Karvai in Long-form Alapana', body: 'In a long Alapana, Karvai (held notes) serve a different function than in Kalpanaswaram.\n\nIn Kalpanaswaram, a Karvai buys thinking time within a tala cycle.\n\nIn long-form Alapana, a Karvai creates:\n1. Emotional stillness — a moment of quiet that intensifies what follows\n2. Structural anchoring — holding a note for 4–10 seconds establishes it as a Nyasa Swara\n3. Audience engagement — a long held note creates tension that the next phrase must resolve\n\nThe best Karvai notes in a long Alapana:\n• Ga3 (the Jiva Swara) — held for 4–8 counts in a slow, meditative phrase\n• Pa — held before beginning the ascent toward Tara Sthayi\n• Sa^ — held at the peak for maximum impact before the cascading descent\n\nA long Alapana is as much about what you do NOT sing as what you do.' },
                    { type: 'free_sing', duration: 20, instruction: 'Movement 1 — Establishment: Sing slowly in the middle register for 20 seconds. Do not go above Pa. Return to Ga3 at least 3 times. Hold any note for 4+ counts whenever it feels right. Say nothing with the upper octave — establish the raga\'s groundedness first.' },
                    { type: 'free_sing', duration: 25, instruction: 'Movements 3 & 4 — Ascent and Climax: Begin from Pa. Make three attempts to reach Sa^ — approach it once, retreat, approach higher, retreat, then arrive fully and hold Sa^ for at least 5 counts. Then cascade all the way down through Ni3, Pa, Ma1, Ga3, Ri1 to Sa. This downward sweep is the emotional culmination.' },
                    { type: 'free_sing', duration: 60, instruction: 'Full long-form Alapana: Sing freely in Mayamalavagowla for 60 seconds following the 5-movement arc — (1) Establish in middle register, (2) Explore with varied phrases, (3) Build toward upper octave, (4) Arrive at Sa^ and cascade down, (5) Resolve with quiet middle-register phrases. No tala. No lyrics. Only the raga.' },
                    { type: 'quiz', question: 'What is the musical purpose of making multiple "approach and retreat" attempts before finally arriving at Sa^?', choices: ['To show the singer cannot reach the high note', 'To build suspense and anticipation — each failed approach increases the emotional impact of the final arrival', 'To warm up the voice gradually for the high note', 'To demonstrate knowledge of the raga\'s Vakra patterns'], correct: 'To build suspense and anticipation — each failed approach increases the emotional impact of the final arrival', explanation: 'Repeatedly approaching Sa^ and retreating is a storytelling technique. Each attempt creates expectation; each retreat creates tension. When the arrival finally comes, the audience experiences resolution both musically and emotionally. This arc is the foundation of concert Alapana architecture.' }
                ]
            }
        ]
    }
...
export const MANODHARMA_ADVANCED_CURRICULUM = MANODHARMA_ADVANCED_CURRICULUM_RAW.map(stage => ({
    ...stage,
    lessons: stage.lessons.map(lesson => ({
        ...lesson,
        exercises: lesson.exercises.map((ex, i) => ({ ...ex, id: ex.id ?? `ex_${i}` }))
...
export const COURSES = [
    ...
    },
    {
        ...
        symbol: '👑',
        color: '#1e3a1f',
        curriculum: MANODHARMA_ADVANCED_CURRICULUM
    }
];
