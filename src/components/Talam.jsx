...
export default function Talam() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto px-4 py-8 space-y-8 relative z-10 talam-container">
                    ...
                    <div key={beatIdx} className="flex flex-col items-center gap-1.5">
                      <div className={[
                        ...
                        isActive
                          ...
                          : 'bg-c-card border-2 border-c-gold/40 text-c-gold-dim', // Finger count: made border thicker and text clearer
                      ].join(' ')}>
                        {isActive && (
      ...
      {/* Tempo control */}
      <div className="heritage-card rounded-xl p-6 space-y-4">
        <div className="absolute inset-0 pointer-events-none">
          <div className="heritage-border-corner heritage-corner-tl" />
          <div className="heritage-border-corner heritage-corner-tr" />
          <div className="heritage-border-corner heritage-corner-bl" />
